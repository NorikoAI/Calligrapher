    ...
    override fun RBuilder.render() {
        ...
        button {
            attrs.onClickFunction = fun(event){
                println(JSON.stringify(app.project.produceGlyph(945, 945)?.path?.toPathData()))
            }
            +"G"
        }
        button {
        ...
        button {
            attrs.onClickFunction = fun(event){
                ...
                /**/
                GlobalScope.launch {
                    println(OpentypeJS.load(app.sourceHanSansTCUrl).await().glyphs.glyphs.toArray()[10000].path.toPathData())
                }
