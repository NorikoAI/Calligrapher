...
fun ObjectGlyph.toArray(): Array<OpentypeJS.Glyph> = asDynamic().values(this)
...
external object OpentypeJS{
    ...
    open class Font(options: Json){
        ...
        fun stringToGlyphs(string: String): Array<Glyph>

        fun charToGlyph(char: String/*Char*/): Glyph
